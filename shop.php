        ...
        <!-- navbar -->
         ...
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index.php">Live Bakery Nepltar</a>
                        ...
                        <div class="product-thumbnail rounded">
                            ...
                            <div class="product-content">
                                ...
                                <div class="product_btn">
                                    ...
                                    <!-- <a href="#" onclick="#(<?php echo $res['product_id'];?>)" class="btn btn-primary">Add to Cart</a> -->
                                    <a href="single_product.php?product_id=<?php echo $res['product_id'];?>" class="btn btn-outline-light">Buy Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            Copyright © 2022 Live Bakery Nepaltar (KTM). All rights reserved. 
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
