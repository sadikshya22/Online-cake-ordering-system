            ...
            <div class="container-fluid dashboard-content">    
                ...
                <div class="row mx-5 justify-content-center">
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 text-center">
                    	<div class="card">
                    		<div class="card-body">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d112997.28614748527!2d85.1571513433594!3d27.743050399999994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb19892a1861c7%3A0x422e9b40526180b0!2sNepaltar%20live%20bakery!5e0!3m2!1sen!2sus!4v1684171399720!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                <h3 class="text-secondary font-italic mt-3 text-left">Address:</h3>
                                <p class="text-secondary font-italic text-left">
                                    Opposite to muktinath bikas bank pvt.ltd left from highway
                                </p>
                                <h3 class="text-secondary font-italic mt-3 text-left">Email:</h3>
                                <p class="text-secondary font-italic text-left">
                                     livebakery@gmail.com
                                </p>
                                <h3 class="text-secondary font-italic mt-3 text-left">Call on:</h3>
                                <p class="text-secondary font-italic text-left">
                                     9811077394 / 9844347110
                                </p>
                    		</div>
                    	</div>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            Copyright © 2022 Nepaltar. All rights reserved.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
